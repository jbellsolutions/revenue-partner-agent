...
| Shell syntax | 18 passed | 14 tracked shell programs plus install and three boot/resume hooks from the assembled template |
| Markdown/HTML local links and assets | 62 resolved | Count derived by `.github/scripts/check_markdown_links.py`; Markdown links/images plus HTML `src`/`href` references |
